...
<p>
    <a href="/phones">Back to Brand list</a>
</p>
<form method="post">
    <h1>Delete Phone</h1>
    <h3>Are you sure?</h3>
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td>Delete By: </td>
                <td><input type="text" name="deleteBy" id="deleteBy" value="${requestScope["phone"].getDeleteBy()}"></td>
            </tr>
            <tr>
                <td><input type="submit" value="Delete phone"></td>
                <td><a href="/phones">Back to brand list</a></td>
            </tr>
        </table>
    </fieldset>
</form></div>
